...
#define OPCODE_BUILD(numDwords, type, info) ( ((uint32_t)( ((((uint16_t)numDwords) << 16) + 0x3FFE0000) | 0xC0001000)) | ((uint8_t)(type)) << 8 | ((uint8_t)(info)))

#define OPCODE_LENGTH(code) ((((uint32_t)(code) & 0x3FFF0000) >> 16) + 2)

#define OPCODE_TYPE(code) (((uint32_t)(code) & 0x0000FF00) >> 8)

#define OPCODE_INFO(code) (((uint32_t)(code) & 0x000000FF))

#define OPCODE_SUB(cmd) (*((uint32_t*)(cmd) + 1))
...
{
	OP_INFO_PUSH_MARKER = 0x00,
	OP_INFO_PUSH_COLOR_MARKER = 0x01,
	OP_INFO_POP_MARKER = 0x02,
	OP_INFO_SET_MARKER = 0x03,
	OP_INFO_SET_CS_SHADER = 0x04,
	OP_INFO_DISPATCH_DIRECT = 0x05,
	OP_INFO_DISPATCH_INDIRECT = 0x06,
};
...
{
	OP_INFO_DRAW_INITIALIZE_DEFAULT_HARDWARE_STATE = 0x00,
	OP_INFO_DRAW_INITIALIZE_TO_DEFAULT_CONTEXT_STATE = 0x01,

	OP_INFO_SET_EMBEDDED_VS_SHADER = 0x02,
	OP_INFO_SET_EMBEDDED_PS_SHADER = 0x03,

	OP_INFO_SET_VS_SHADER = 0x04,
	OP_INFO_SET_PS_SHADER = 0x05,
	OP_INFO_SET_ES_SHADER = 0x06,
	OP_INFO_SET_GS_SHADER = 0x07,
	OP_INFO_SET_HS_SHADER = 0x08,
	OP_INFO_SET_LS_SHADER = 0x09,
	OP_INFO_UPDATE_GS_SHADER = 0x0A,
	OP_INFO_UPDATE_HS_SHADER = 0x0B,
	OP_INFO_UPDATE_PS_SHADER = 0x0C,
	OP_INFO_UPDATE_VS_SHADER = 0x0D,

	OP_INFO_SET_VGT_CONTROL = 0x0E,
	OP_INFO_RESET_VGT_CONTROL = 0x0F,

	OP_INFO_DRAW_INDEX = 0x10,
	OP_INFO_DRAW_INDEX_AUTO = 0x11,
	OP_INFO_DRAW_INDEX_INDIRECT = 0x12,
	OP_INFO_DRAW_INDEX_INDIRECT_COUNT_MULTI = 0x13,
	OP_INFO_DRAW_INDEX_MULTI_INSTANCED = 0x14,
	OP_INFO_DRAW_INDEX_OFFSET = 0x15,
	OP_INFO_DRAW_INDIRECT = 0x16,
	OP_INFO_DRAW_INDIRECT_COUNT_MULTI = 0x17,
	OP_INFO_DRAW_OPAQUE_AUTO = 0x18,

	OP_INFO_WAIT_UNTIL_SAFE_FOR_RENDERING = 0x19,
};
...
enum OpTypeDraw : uint8_t
{
	...
	OP_TYPE_SET_CONTEXT = 0x69,
	OP_TYPE_SET_RESOURCE = 0x76,
	OP_TYPE_SET_3 = 0x79,
...
enum OpSubDraw
{
	...
	OP_SUB_SET_USER_DATA_REGION = 0x6875000D,
};
...
enum OpSubPrivateDispatch : uint8_t
{
	...
	// used for OPCODE_BUILD
	OP_INFO_DISPATCH_INITIALIZE_DEFAULT_HARDWARE_STATE = 0x00,
};
