...
{
	OP_TYPE_INITIALIZE_DEFAULT_HARDWARE_STATE = 0xFF00,
	OP_TYPE_INITIALIZE_TO_DEFAULT_CONTEXT_STATE = 0xFF01,

	OP_TYPE_SET_EMBEDDED_VS_SHADER = 0xFF02,
	OP_TYPE_SET_EMBEDDED_PS_SHADER = 0xFF03,

	OP_TYPE_SET_CS_SHADER = 0xFF04,
	OP_TYPE_SET_VS_SHADER = 0xFF05,
	OP_TYPE_SET_PS_SHADER = 0xFF06,
	OP_TYPE_SET_ES_SHADER = 0xFF07,
	OP_TYPE_SET_GS_SHADER = 0xFF08,
	OP_TYPE_SET_HS_SHADER = 0xFF09,
	OP_TYPE_SET_LS_SHADER = 0xFF0A,
	OP_TYPE_UPDATE_GS_SHADER = 0xFF0B,
	OP_TYPE_UPDATE_HS_SHADER = 0xFF0C,
	OP_TYPE_UPDATE_PS_SHADER = 0xFF0D,
	OP_TYPE_UPDATE_VS_SHADER = 0xFF0E,

	OP_TYPE_SET_VGT_CONTROL = 0xFF0F,
	OP_TYPE_RESET_VGT_CONTROL = 0xFF10,

	OP_TYPE_PUSH_MARKER = 0xFF11,
	OP_TYPE_POP_MARKER = 0xFF12,
	OP_TYPE_SET_MARKER = 0xFF13,

	OP_TYPE_DRAW_INDEX = 0xFF14,
	OP_TYPE_DRAW_INDEX_AUTO = 0xFF15,
	OP_TYPE_DRAW_INDEX_INDIRECT = 0xFF16,
	OP_TYPE_DRAW_INDEX_INDIRECT_COUNT_MULTI = 0xFF17,
	OP_TYPE_DRAW_INDEX_MULTI_INSTANCED = 0xFF18,
	OP_TYPE_DRAW_INDEX_OFFSET = 0xFF19,
	OP_TYPE_DRAW_INDIRECT = 0xFF1A,
	OP_TYPE_DRAW_INDIRECT_COUNT_MULTI = 0xFF1B,
	OP_TYPE_DRAW_OPAQUE_AUTO = 0xFF1C,

	OP_TYPE_DISPATCH_DIRECT = 0xFF1D,
	OP_TYPE_DISPATCH_INDIRECT = 0xFF1E,

	OP_TYPE_WAIT_UNTIL_SAFE_FOR_RENDERING = 0xFF1F,
};
