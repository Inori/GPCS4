...
void GnmCommandBufferDispatch::setCsShader(const pssl::CsStageRegisters* csRegs, uint32_t shaderModifier)
{
	throw std::logic_error("The method or operation is not implemented.");
}
...
void GnmCommandBufferDispatch::setDepthStencilControl(DepthStencilControl depthStencilControl)
{
	throw std::logic_error("The method or operation is not implemented.");
}
...
void GnmCommandBufferDispatch::setPrimitiveSetup(PrimitiveSetup primSetup)
{
	throw std::logic_error("The method or operation is not implemented.");
}
...
void GnmCommandBufferDispatch::setSsharpInUserData(ShaderStage stage, uint32_t startUserDataSlot, const SSharpBuffer* sampler)
{
	throw std::logic_error("The method or operation is not implemented.");
}
...
void GnmCommandBufferDispatch::setTsharpInUserData(ShaderStage stage, uint32_t startUserDataSlot, const TSharpBuffer* tex)
{
	throw std::logic_error("The method or operation is not implemented.");
}
...
void GnmCommandBufferDispatch::setVgtControl(uint8_t primGroupSizeMinusOne, WdSwitchOnlyOnEopMode wdSwitchOnlyOnEopMode, VgtPartialVsWaveMode partialVsWaveMode)
{
	throw std::logic_error("The method or operation is not implemented.");
}
...
void GnmCommandBufferDispatch::setVsharpInUserData(ShaderStage stage, uint32_t startUserDataSlot, const VSharpBuffer* buffer)
{
	throw std::logic_error("The method or operation is not implemented.");
}
