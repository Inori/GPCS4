...
const std::array<GveFormatInfo, 149> g_formatInfos = 
{ {
	// VK_FORMAT_UNDEFINED
	{},
	...
	// VK_FORMAT_R8_UINT
	{ 1, VK_IMAGE_ASPECT_COLOR_BIT,
	  GveFormatFlag::SampledUInt },

	// VK_FORMAT_R8_SINT
	{ 1, VK_IMAGE_ASPECT_COLOR_BIT,
	  GveFormatFlag::SampledSInt },

	// VK_FORMAT_R8_SRGB
	{ 1, VK_IMAGE_ASPECT_COLOR_BIT,
	  GveFormatFlag::ColorSpaceSrgb },
...
{
	const GveFormatInfo* formatInfo  = nullptr;
