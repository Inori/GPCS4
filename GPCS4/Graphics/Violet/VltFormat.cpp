...
namespace sce::vlt
{
	...
	const std::array<VltFormatInfo, 152> g_formatInfos = { {
		// VK_FORMAT_UNDEFINED
		{},
		...
		{ 6, VK_IMAGE_ASPECT_PLANE_0_BIT | VK_IMAGE_ASPECT_PLANE_1_BIT, VltFormatFlag::MultiPlane, VkExtent3D{ 1, 1, 1 }, { VltPlaneFormatInfo{ 1, { 1, 1 } }, VltPlaneFormatInfo{ 2, { 2, 2 } } } },
	} };
